...
function App() {
  ...
  return (
    <div>
      <header>
        <h1>Pushkar's Dummy Portfolio</h1>
      </header>
      <nav>
        <ul>
          <li>
      ...
      <div className="container2" id="about">
        <h2>About Me</h2>
        <p>
          Hi, I'm <b>Pushkar</b>. I'm a web developer. This is a Dummy portfolio created using React.
        </p>
        </div>
      ...
      <div className="container" id="contact">
        <h2>Contact Me</h2>
        <p>Email: pushkar.joshi@example.com</p>
      </div>
    </div>
  );
}
